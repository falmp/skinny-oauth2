...
object SkinnyAppBuild extends Build {
  ...
  val appOrganization = "com.bionexo"
  val appName = "skinny-oauth2"
  val appVersion = "0.1.0-SNAPSHOT"

  val skinnyVersion = "1.3.11"
  ...
  lazy val baseSettings = ScalatraPlugin.scalatraWithJRebel ++ herokuSettings ++ Seq(
    ...
    // Google OAuth 2.0
    javaOptions ++= Seq("-DSKINNY_OAUTH2_CLIENT_ID_GOOGLE=385062143573-d5r537d2lrtgs21q5ldd8ck1l9pj9g5n.apps.googleusercontent.com"),
    javaOptions ++= Seq("-DSKINNY_OAUTH2_CLIENT_SECRET_GOOGLE=NWgZMP2u9EHXbAnzuye6hImK")
  )
